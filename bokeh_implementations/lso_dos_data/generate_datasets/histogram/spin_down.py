...
for fname in file_list:
    ...
    dos_binned, _ = np.histogram(energies, bins=bin_edges, weights=dens_dn)
...
out_file = os.path.join(output_dir, "dos_dataset_histogram_5_ev_cutoff_after_bandgap_spin_down.csv")
