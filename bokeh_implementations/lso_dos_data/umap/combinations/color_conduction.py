...
palette = Category10[len(unique_cond_types)]
...
color_map = factor_cmap(COND_TYPE_STRING, palette=palette, factors=unique_cond_types)

plot.circle(
    X_AXIS_STRING, Y_AXIS_STRING,
    source=source, size=7, alpha=0.7,
    color=color_map, legend_field=COND_TYPE_STRING
)
